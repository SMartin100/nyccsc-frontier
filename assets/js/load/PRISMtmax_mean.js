...
$( "#panel-legend-PRISMtmax_mean" ).append('<div><label for="amount-PRISMtmax_mean">Mean Max. Temp. (Monthly):</label><input type="text" id="amount-PRISMtmax_mean" readonly style="border:0; color:#f6931f; font-weight:bold;"></div><div id="slider-PRISMtmax_mean"></div>' );

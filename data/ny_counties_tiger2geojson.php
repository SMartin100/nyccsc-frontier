...
$sql = "SELECT a.name, a.countyfp, public.ST_AsGeoJSON(public.ST_Transform(a.geom,4326),6) as geojson  FROM boundaries.ny_counties_tiger AS a;";
...
$f = fopen("ny_counties_tiger.geojson", "w"); 

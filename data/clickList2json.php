...
$query = "SELECT a.name AS county_name, 
              ...
              (((((st_xmin(st_envelope(st_transform(a.geom, 4326))::box3d) || ' '::text) || st_ymin(st_envelope(st_transform(a.geom, 4326))::box3d)) || ' '::text) || st_xmax(st_envelope(st_transform(a.geom, 4326))::box3d)) || ' '::text) || st_ymax(st_envelope(st_transform(a.geom, 4326))::box3d) AS county_bbox,
              b.name AS huc8_name, 
              b.huc8, 

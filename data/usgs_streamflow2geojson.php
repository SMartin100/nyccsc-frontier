...
$sql = "SELECT a.name,a.station_id, a.time, a.date, a.stage, a.discharge, a.class, a.url, a.moreinfo, public.ST_AsGeoJSON(public.ST_Transform(a.geom,4326),6) as geojson FROM water.usgs_streamflow AS a
        ;";
...
$f = fopen("usgs_streamflow.geojson", "w"); 
